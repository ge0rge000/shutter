      ...
      <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item"><a ><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span></a>
              <ul class="menu-content">
                ...
                <li ><a class="menu-item"  href="{{route("show_shutters")}}" data-i18n="nav.dash.ecommerce">show shutters</a>
                </li>
                <li ><a class="menu-item" href="{{route("add_shutter")}}" data-i18n="nav.dash.ecommerce">add shutter</a>
                </li>
                <li ><a class="menu-item"  href="{{route("cartegory_photo_list")}}" data-i18n="nav.dash.ecommerce">Category Photo list </a>
                </li>
                <li ><a class="menu-item" href="{{route("add_cartegory_photo")}}" data-i18n="nav.dash.ecommerce">add category photos </a>
                </li>
                <li ><a class="menu-item" href="{{route("quotes_admin")}}" data-i18n="nav.dash.ecommerce">Quotes </a>
                </li>
